...
<body>
    ...
    <div>
        <h3 class="text-uppercase fw-bold" style="color: var(--color8);">RETIRO</h3>
            ...
            <div class="row justify-content-center">
                <div class="col-xl-10">
                    <div id="content-grid" class="pt-4">
                        <a class="img-links" data-gall="gallery01" title="RETIRO" href="./public/img/galeria/retiro1.jpg"><img src="./public/img/galeria/retiro1.jpg" class="mb-2" width="100%"></a>
                        <a class="img-links" data-gall="gallery01" title=" RETIRO" href="./public/img/galeria/retiro2.jpg"><img src="./public/img/galeria/retiro2.jpg" class="mb-2" width="100%"></a>
                        <a class="img-links" data-gall="gallery01" title="RETIRO" href="./public/img/galeria/retiro3.png"><img src="./public/img/galeria/retiro3.png" class="mb-2" width="100%"></a>
                        <a class="img-links" data-gall="gallery01" title="RETIRO" href="./public/img/galeria/retiro4.jpg"><img src="./public/img/galeria/retiro4.jpg" class="mb-2" width="100%"></a>
                    </div>
                </div>
            </div>
