...
<body>
    ...
    <div>
        <h3 class="text-uppercase fw-bold" style="color: var(--color8);"> COMUNIÓN</h3>
            ...
            <div class="row justify-content-center">
                <div class="col-xl-10">
                    <div id="content-grid" class="pt-4">
                        <a class="img-links" data-gall="gallery01" title="COMUNIÓN" href="./public/img/galeria/pastoral1.jpg"><img src="./public/img/galeria/pastoral1.jpg" class="mb-2" width="100%"></a>
                        <a class="img-links" data-gall="gallery01" title=" COMUNIÓN" href="./public/img/galeria/pastoral2.jpg"><img src="./public/img/galeria/pastoral2.jpg" class="mb-2" width="100%"></a>
                        <a class="img-links" data-gall="gallery01" title=" COMUNIÓN" href="./public/img/galeria/pastoral4.jpg"><img src="./public/img/galeria/pastoral4.jpg" class="mb-2" width="100%"></a>
                        <a class="img-links" data-gall="gallery01" title=" COMUNIÓN" href="./public/img/galeria/pastoral3.jpg"><img src="./public/img/galeria/pastoral3.jpg" class="mb-2" width="100%"></a>
                    </div>
                </div>
            </div>
