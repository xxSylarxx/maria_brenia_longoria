            ...
            <div class="container">
                ...
                <div class="row cards d-flex justify-content-center align-items-center">
                        ...
                        <div class="card-galeria card2 mx-4">
                            ...
                            <div class="details">
                                <div class="row d-flex">
                                    <div class="col-lg-9">
                                        <h3>Admisión 2026</h3>
                                        <a class="btn" href="./view3.php?id=1">Ver Más</a>
                                    </div>
                    ...
                    <div class="col-lg-4 pt-5">
                        <div class="card-galeria card2 mx-4">
                            <div class="container-galeria">
                                <img id="portada-galeria" src="./public/img/portadas/noticias2.jpg" alt="galeria">
                            </div>
                            <div class="details">
                                <div class="row d-flex">
                                    <div class="col-lg-9">
                                        <h3>Fe y alegría en María Auxiliadora</h3>
                                        <a class="btn" href="./view3.php?id=2">Ver Más</a>
                                    </div>
                                    <div class="col-lg-3 d-flex justify-content-end align-items-center">
                                        <img src="./public/img/icons/logo.png" width="80%" alt="">
                                    </div>
                    ...
                    <div class="col-lg-4 pt-5">
                        <div class="card-galeria card3 mx-4">
                            <div class="container-galeria">
                                <img id="portada-galeria" src="./public/img/portadas/noticias3.jpg" alt="galeria">
                            </div>
                            <div class="details">
                                <div class="row d-flex">
                                    <div class="col-lg-9">
                                        <h3>Celebramos al Papa León XIV</h3>
                                        <a class="btn" href="./view3.php?id=3">Ver Más</a>
                                    </div>
                                    <div class="col-lg-3 d-flex justify-content-end align-items-center">
                                        <img src="./public/img/icons/logo.png" width="80%" alt="">
                                    </div>
