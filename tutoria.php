    ...
    <section id="propuesta">
        <div class="container">
            <div class="row py-5">
                <div class="col-lg-6 px-2 my-auto">
                    <h2 class="text-start" style="color:black;">Tutoría</h2>
                    <div class="separador mx-start"></div>
                    <br><br>
                    <p style="font-size:1.4rem;text-align:center;font-weight:bold;color:var(--color1);">Orientación para la Tutoría:</p>
                    <p>
                    ...
                    <p>
                        Nuestros tutores cumplen un rol fundamental como acompañantes cercanos en el crecimiento personal, académico y emocional de las estudiantes. Desde una mirada preventiva y formativa, identifican necesidades, promueven valores y fortalecen el bienestar estudiantil, trabajando en estrecha coordinación con docentes, directivos y familias.
                    </p>
                </div>
        ...
        <div class="container">
            <div class="row py-5">
                <div class="col-lg-6 my-auto">
                    <div class="d-flex justify-content-center mx-5">
                        <img src="./public/img/web/metodologia2.jpeg" style="border-radius:8px;width:100%" alt="">
                    </div>
                </div>
                <div class="col-lg-6 my-auto">
