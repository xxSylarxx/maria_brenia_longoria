        ...
        <div class="container py-1">
            <div class="row d-flex justify-content-between">
                <div class="col-lg-6">
                    ...
                    <div class="mx-5">
                        <h1 class="text-start" style="color:black;">Nivel Secundaria</h1>
                        <div class="separador mx-start"></div>
                        <br>
                        <p>En la etapa de Secundaria, potenciamos el pensamiento crítico, la responsabilidad y la preparación para el futuro:</p>
                        <br>
                        <div class="row">
                            <div class="col-lg">
                                <p><i class="fas fa-check" style="color:var(--color4);font-weight:bold;"></i>&nbsp;Metodología por competencias, integrando teoría y práctica para resolver situaciones reales.</p>
                                <p><i class="fas fa-check" style="color:var(--color4);font-weight:bold;"></i>&nbsp;Orientación vocacional y socioemocional, que guía a nuestras estudiantes en su proyecto de vida.</p>
                                <p><i class="fas fa-check" style="color:var(--color4);font-weight:bold;"></i>&nbsp;Proyectos interdisciplinarios, que conectan áreas del conocimiento con la realidad social.</p>
                                <p><i class="fas fa-check" style="color:var(--color4);font-weight:bold;"></i>&nbsp;Tecnología educativa, aplicada en entornos virtuales y colaborativos para fortalecer el aprendizaje autónomo.</p>
                            </div>
                ...
                <div class="col-lg-6 d-flex justify-content-center align-items-center my-auto">
                    <div>
                        <img src="./public/img/web/secundaria.jpg" class="img-fluid" style="border-radius: 10px;" alt="">
                    </div>
                </div>
            </div>
                        ...
                        <table class="elite-plan">
                            <thead>
                                <tr>
                                    ...
                                    <th colspan="5" style="text-align:center;">NÚMERO DE HORAS / GRADO DE ESTUDIO</th>
                                </tr>
                                <tr>
                                    <th>1°</th>
                                    <th>2°</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="area-curricular important-subject">CCSS</td>
                                    <td>3</td>
                                    <td>3</td>
                                    <td>3</td>
                                    <td>3</td>
                                ...
                                <tr>
                                    <td class="area-curricular special-subject">DPCC</td>
                                    <td>3</td>
                                    <td>3</td>
                                    <td>3</td>
                                    <td>3</td>
                                ...
                                <tr>
                                    <td class="area-curricular">SIMULACRO EX.ADMISIÓN</td>
                                    <td>-</td>
                                    <td>-</td>
                                    <td>1</td>
                                    <td>1</td>
                                ...
                                <tr>
                                    <td class="area-curricular">ED. RELIGIOSA</td>
                                    <td>2</td>
                                    <td>2</td>
                                    <td>2</td>
                                    <td>2</td>
                                ...
                                <tr>
                                    <td class="area-curricular important-subject">ED. FÍSICA</td>
                                    <td>2</td>
                                    <td>2</td>
                                    <td>2</td>
                                    <td>2</td>
                                ...
                                <tr>
                                    <td class="area-curricular">INGLÉS</td>
                                    <td>3</td>
                                    <td>3</td>
                                    <td>3</td>
                                    <td>3</td>
                                ...
                                <tr>
                                    <td class="area-curricular">ITALIANO</td>
                                    <td>2</td>
                                    <td>2</td>
                                    <td>2</td>
                                    <td>2</td>
                                 ...
                                 <tr>
                                    <td class="area-curricular">GRUPO EJS*</td>
                                    <td>1</td>
                                    <td>1</td>
                                    <td>1</td>
                                    <td>1</td>
