...
<header id="header" style="background-color:var(--color1);" class="fixed-top">
    <!-- <div id="bar-sup">

        <div class="d-flex justify-content-around">
            <a href="" class="mx-3 my-1" style="color:var(--color1);" target="_blank"><i class="fas fa-envelope"></i><span> Correo</span></a>
            <a href="" class="me-3 my-1" style="color:var(--color1);" target="_blank"><i class="fas fa-file-certificate"></i><span> Seesaw</span></a>
            <a href="" class="me-3 my-1" style="color:var(--color1);" target="_blank"><i class="fas fa-chalkboard-teacher"></i><span> Classroom</span></a>
            <a href="" class="me-3 my-1" style="color:var(--color1);" target="_blank"><i class="fas fa-book-open"></i><span> Destiny</span></a>
            <a href="" class="me-3 my-1" style="color:var(--color1);" target="_blank"><i class="fas fa-laptop"></i><span> Davy Online</span></a>
       </div>
    </div> -->
                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    ...
                    <li id="barra-menu-responsive" class="nav-item" onmouseover="showMenuHover(3)" onmouseout="showMenuHover2(3)">
                        ...
                        <ul id="menu-responsive" class="dropdown-menu animate__animated animate__fadeInUp" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item py-2" href="./tutoria">Tutoría</a></li>
...
<script>
    ...
    document.getElementById("barra-menu-responsive").onclick = function() {
        mostrarresponsive();
    }
</script>
